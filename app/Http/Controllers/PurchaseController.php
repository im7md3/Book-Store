    ...
    public function createPayment(Request $request) 
    {
        $apiContext = new \PayPal\Rest\ApiContext(
            new \PayPal\Auth\OAuthTokenCredential(
                'AVlSafBzSnhIG8tbbTh8vTcUDqikpu6sySNg5WHYGlvaW97u3Yavvn0cyNPu_nJFdyHX23LWY2UgGY4v', 
                'ENJNkMUIcnOtGu3D4QkYtQO0ETLB0c_1eFRW7YsCQLQmLCbByCoUo4ufnPlFWLV5ZmUrIAlIxiECQtdX')
        );
        ...
        $books = User::find($request->userId)->bookInCart;
        $itemsArray = array();
        $total = 0;
